        ...
        {data.map((item, i) => {
          ...
          return (
            <button key={item.title} onClick={() => setIdx(absoluteIndex)} className="overflow-hidden rounded-2xl glass neon-hover text-left">
              ...
              <div className="p-4">
                <p className="text-xs uppercase tracking-[0.2em] text-[color:var(--muted)]">{item.category}</p>
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/75 p-4" onClick={() => setIdx(null)}>
            ...
            <div className="flex items-center justify-between gap-3 pb-3">
              ...
              <div className="flex gap-2">
                <button
                  className="rounded-full border border-[color:var(--border)] px-4 py-2 text-sm neon-hover"
